...
<body>
	...
	<p align="right">
		...
		<form action="./saveDetails" method="post"
						enctype="multipart/form-data" onsubmit="return housingFormValidation()">
		<div>
	...
	<h3 align="center">Property Pre-Booking Form</h3>
						<div class="row">
							<div class="form-group col-md-4">
								<label>Housing Project :</label> <select
							...
							<div class="form-group col-md-4">
								<label>Property Cost:</label> <input disabled="disabled"
						...
						<div class="container"
							...
							<div class="row">
								<div class="form-group col-md-4">
									<label>Applicant Name :</label> <input type="text"
							...
							<div class="row">
								...
								<div class="form-group col-md-4">
									<label>Upload Id Proof :</label> <input type="file"
